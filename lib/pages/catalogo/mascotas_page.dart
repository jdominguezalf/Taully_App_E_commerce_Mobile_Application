// ---------------------------------------------------
// 🐾 Archivo: ricocan_page.dart
// Proyecto: Minimarket Taully
// Descripción: Página de categoría "Comida para Animales"
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, ofertasSnapshot) {
        ...
        // 2️⃣ Ahora escuchamos los productos de Comida para Animales
              ...
              appBar: PreferredSize(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    color: Color(0xFF4CAF50), // verde principal
