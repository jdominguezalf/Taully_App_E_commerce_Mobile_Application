// ---------------------------------------------------
// 🛒 Archivo: abarrotes_page.dart
// Proyecto: Minimarket Taully
// Descripción: Página de categoría "Abarrotes" con AppBar
//              compacto, carrito funcional y cuadrícula de
//              productos. Integra ofertas activas vinculadas
//              por productoId (colección products).
// ---------------------------------------------------
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, ofertasSnapshot) {
        ...
        debugPrint(
            '📦 Ofertas activas: ${ofertasDocs.length} | con productoId: ${ofertasPorProductoId.length}');

        // 2️⃣ Ahora escuchamos los productos de Abarrotes
        return StreamBuilder<List<Map<String, dynamic>>>(
          ...
          builder: (context, snapshot) {
            ...
            debugPrint('🛒 Productos Abarrotes: ${productos.length}');

            return Scaffold(
              // ===================================================
              // 🍊 APPBAR personalizado — Compacto, moderno y centrado
              // ===================================================
              appBar: PreferredSize(
                ...
                child: Container(
                  ...
                  decoration: const BoxDecoration(
                    color: Color(0xFFFF9800), // naranja fuerte
    ...
    return GridView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        if (oferta != null && oferta['precioOferta'] != null) {
          ...
          debugPrint(
              '🔥 Oferta aplicada a producto $productId | precioFinal: $precioFinal');
        }
                    ...
                    children: [
                      ...
                      ElevatedButton.icon(
                        ...
                        onPressed: () {
                          ...
                          // Enviamos al carrito el producto con el precio final
